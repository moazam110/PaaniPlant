...
export interface DeliveryRequest {
  ...
  cancellationReason?: 'door_closed' | 'duplicate' | 'other' | 'not_needed_today' | 'ordered_by_mistake' | 'system_problem' | 'area_not_reachable' | 'bad_weather' | 'no_stock_available'; // Reason for cancellation
